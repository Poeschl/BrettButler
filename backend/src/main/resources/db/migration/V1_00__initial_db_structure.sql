...
(
    id       integer DEFAULT nextval('playing_game_id_seq'::regclass) NOT NULL,
...
(
    id              integer DEFAULT nextval('playing_game_user_id_seq'::regclass) NOT NULL,
    playing_game_id integer                                                       NOT NULL,
